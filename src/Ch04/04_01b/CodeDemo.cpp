...
int main(){
    ...
    std::cout << "Level 4: " << enemies[3] << " enemies" << std::endl << std::endl;

    std::cout << "The level difficulties are as follows:" << std::endl;
    ...
    std::cout << "Level 4: " << levelDifficulty[3] << std::endl << std::endl;
